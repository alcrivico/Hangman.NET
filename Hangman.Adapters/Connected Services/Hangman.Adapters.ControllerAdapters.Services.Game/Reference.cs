...
namespace Hangman.Adapters.ControllerAdapters.Services.Game
{
    ...
    public partial class GameServicesClient : System.ServiceModel.ClientBase<Hangman.Adapters.ControllerAdapters.Services.Game.IGameServices>, Hangman.Adapters.ControllerAdapters.Services.Game.IGameServices
    {
        ...
        private static System.ServiceModel.Channels.Binding GetBindingForEndpoint(EndpointConfiguration endpointConfiguration)
        {
            ...
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpsBinding_IGameServices))
            {
                System.ServiceModel.BasicHttpBinding result = new System.ServiceModel.BasicHttpBinding();
                result.MaxBufferSize = int.MaxValue;
                result.ReaderQuotas = System.Xml.XmlDictionaryReaderQuotas.Max;
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IGameServices))
            {
                return new System.ServiceModel.EndpointAddress("http://hangmanservices.azurewebsites.net/Communications/GameServices.svc");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpsBinding_IGameServices))
            {
                return new System.ServiceModel.EndpointAddress("https://hangmanservices.azurewebsites.net/Communications/GameServices.svc");
            }
            throw new System.InvalidOperationException(string.Format("No se pudo encontrar un punto de conexión con el nombre \"{0}\".", endpointConfiguration));
        }
        ...
        public enum EndpointConfiguration
        {
            ...
            BasicHttpsBinding_IGameServices,
        }
    }
}
